...
class EventDetailProblem(models.Model):
    eventmainproblem = models.ForeignKey(EventMainProblem,on_delete=models.CASCADE)
    name =  models.CharField(max_length=255,unique=True)
    def __str__(self):
        return self.name
...
class EventKindofProblem(models.Model):
    ...
    mainproblem = models.ForeignKey(EventMainProblem,on_delete=models.RESTRICT)
    detailproblem = models.ForeignKey(EventDetailProblem,on_delete=models.RESTRICT)
    Bank= models.ForeignKey(Bank,on_delete=models.RESTRICT,null=True,blank=True)
    image = models.ImageField(upload_to='event_image',null=True , blank=True)
    city= models.ForeignKey(city,on_delete=models.RESTRICT,null=True,blank=True,related_name='city+')
    Connection=models.ForeignKey(Connection,on_delete=models.RESTRICT,null=True,blank=True,related_name='Connection+')
    ...
    ReportToDepartment= models.ForeignKey(Report_To,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    Assign_to_name1=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    Assign_to_name2=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    Assign_to_name3=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    Assign_to_name4=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    Assigng_to_others=models.ForeignKey(Other_Organization,on_delete=models.RESTRICT,null=True,blank=True , related_name='auth.user+')
    ...
    Expert1 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert1 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert2 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert2 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert3 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert3 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert4 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert4 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert5 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert5 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert6 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert6 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert7 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert7 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert8 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert8 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert9 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert9 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert10 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert10 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert11 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Status_Of_Expert11 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
    Expert12 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
...
class Push(models.Model):
    ...
    status_choice = (('open','OPEN'),('in progress','IN PROGRESS'),('close','CLOSE'))
    status = models.CharField(choices=status_choice,max_length=25,null=True,blank=True)
    organization=models.ForeignKey(Push_Organization,on_delete=models.RESTRICT,null=True,related_name='auth.user+')
    description = models.TextField(max_length=255)
    Status_Of_People = (('present','PRESENT'),('registrator','REGISTRATOR'),('completor','COMPLETOR'),('remote','REMOTE'))
    Expert1 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Staus_Of_Expert1 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
...
class Access(models.Model):
    boss=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    start_date = jmodels.jDateTimeField()
    end_date = jmodels.jDateTimeField(null=True,blank=True)
    expertise=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    reson = models.TextField(max_length=255)
    Status_Of_People = (('present','PRESENT'),('registrator','REGISTRATOR'),('completor','COMPLETOR'),('remote','REMOTE'))
    Expert1 = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    Staus_Of_Expert1 = models.CharField(choices=Status_Of_People,max_length=25,null=True,blank=True)
...
class NoAnswerCall(models.Model):
    ...
    expertise=models.ForeignKey(assign_to,on_delete=models.RESTRICT,null=True,blank=True,related_name='auth.user+')
    caller = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
...
class ResponseTime(models.Model):
    ...
    registrator = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    def __str__(self):
        return self.name
    class Meta:  
...
class APNIrancell(models.Model):
    ...
    number1= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    number2= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    number3= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    number4= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    number5= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    number6= models.ForeignKey(IrancellNumber,on_delete=models.RESTRICT,null=True,blank=True,related_name='Irancellnumber+')
    registrator = models.ForeignKey(expert,on_delete=models.RESTRICT,null=True,blank=True,related_name='expert+')
    description = models.TextField(max_length=255)
    def __str__(self):
        return self.name
